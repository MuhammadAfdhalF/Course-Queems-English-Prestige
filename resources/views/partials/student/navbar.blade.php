...
$studentUnreadNotifications = auth()->check()
        ...
        <div class="flex items-center justify-between py-4">
            ...
            <div class="hidden items-center gap-4 lg:flex">
                ...
                <a
                    ...
                    <span class="absolute right-1 top-1 inline-flex h-4 min-w-[16px] items-center justify-center rounded-full bg-[#AD6B10] px-1 text-[10px] font-bold text-white">
