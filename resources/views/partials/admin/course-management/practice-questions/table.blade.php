<x-admin.data-table>
    ...
    'delete_url' => route('admin.course-management.practice-questions.destroy', $question),
    ];
    ...
    <tr class="text-sm text-slate-700">
        ...
        <td class="px-6 py-4">
            <div class="flex justify-center gap-2">
                <a
                    href="{{ route('admin.course-management.practice-questions.edit', $question) }}"
                    title="Edit"
    ...
    <x-admin.empty-state
        ...
        description="Create the first question for this practice." />
    @endforelse
</x-admin.data-table>