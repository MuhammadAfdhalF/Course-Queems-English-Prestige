    ...
    <div class="flex items-center justify-between gap-4 px-4 py-4 lg:px-8">
        <div class="flex min-w-0 items-center gap-3">
            <button
                ...
                type="button"
                class="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white p-2 text-slate-700 shadow-sm transition hover:bg-slate-50 lg:hidden">
        ...
        <div class="flex items-center gap-3 lg:gap-4">
            ...
            <button
                ...
                <span class="absolute right-1 top-1 inline-flex h-4 min-w-[16px] items-center justify-center rounded-full bg-[var(--color-brand-gold)] px-1 text-[10px] font-bold text-white">
                    3
                </span>
            </button>
