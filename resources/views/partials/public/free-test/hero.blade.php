<section class="relative overflow-hidden border-b border-slate-200 bg-[#F7FAFD]">
    ...
    <div class="relative mx-auto max-w-7xl px-4 py-16 text-center lg:px-8 lg:py-20">
        <p class="text-xs font-semibold uppercase tracking-[0.22em] text-[#2457E6]">
            100% Free Assessment
        </p>

        <h1 class="mt-4 text-4xl font-bold leading-tight text-[var(--color-brand-blue)] md:text-5xl">
            Free English <br>
