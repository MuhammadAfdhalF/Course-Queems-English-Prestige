    ...
    <div class="space-y-12">
        <div class="reveal">
            ...
            <div class="mt-5 space-y-5 text-base leading-8 text-slate-600">
                <p>
                    This comprehensive course is designed for professionals and academics who wish
                    to elevate their writing to a world-class standard. Whether you are drafting
                    executive reports, publishing research, or crafting influential white papers,
                    this program provides the tools necessary to communicate complex ideas with
                    clarity, precision, and authority.
                </p>

                <p>
                    Our curriculum focuses on bridging the gap between technical expertise and
                    effective narrative structure, ensuring your message resonates with stakeholders
                    and peer reviewers alike.
                </p>
            </div>

            <ul class="mt-6 list-disc space-y-1 pl-6 text-base font-semibold text-slate-800">
                <li>Develop sophisticated structural integrity in long-form documents.</li>
                <li>Master the nuances of formal tone and academic vocabulary.</li>
                <li>Learn to use rhetorical devices for persuasive advocacy.</li>
                <li>Master the nuances of formal tone and academic vocabulary.</li>
                <li>Receive personalized feedback from senior education consultants.</li>
            </ul>
        </div>
