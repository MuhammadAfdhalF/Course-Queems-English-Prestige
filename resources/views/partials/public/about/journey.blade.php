        ...
        <div class="max-w-2xl">
            ...
            <div class="reveal reveal-delay-1 mt-6 space-y-5 text-sm leading-8 text-slate-600 md:text-base">
                ...
                <p>
                    ...
                    by our admin team (Pending / Approved / Rejected). Once approved, you gain full
                    access to your course content and learning progress. After completing all modules
                    and passing the final exam, you can receive your certificate according to the
                    course requirements.
                </p>
            </div>
        </div>
