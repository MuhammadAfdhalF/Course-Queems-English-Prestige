<section class="relative overflow-hidden border-b border-slate-200 bg-[#F7FAFD]">
    ...
    <div class="relative mx-auto max-w-7xl px-4 py-16 lg:px-8 lg:py-20">
        <div class="max-w-xl">
            <div class="inline-flex items-center gap-2 rounded-md border border-amber-200 bg-white/90 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-[var(--color-brand-gold)]">
                <span>🏛</span>
                Our Story
            </div>

            <h1 class="mt-5 text-4xl font-bold leading-tight text-[var(--color-brand-blue)] md:text-5xl">
