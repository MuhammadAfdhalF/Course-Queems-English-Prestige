<section class="relative overflow-hidden border-b border-slate-200 bg-[#F7FAFD]">
    ...
    <div class="relative mx-auto max-w-7xl px-4 py-16 text-center lg:px-8 lg:py-20">
        <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full border border-[var(--color-brand-blue)] bg-white shadow-sm">
        ...
        <h1 class="mt-6 text-4xl font-bold leading-tight text-[var(--color-brand-blue)] md:text-5xl">
