        ...
        <div class="grid gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div>
                ...
                <div class="mt-8 space-y-3">
                    <div x-data="{ open: false }" class="overflow-hidden rounded-xl border border-slate-300 bg-white">
                        <button
                            @click="open = !open"
                            type="button"
            ...
            <div>
                ...
                <div class="mt-8 grid gap-5 sm:grid-cols-2">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-slate-500">consultancy@elite-english.edu</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-slate-500">0852-7497-9356</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-slate-500">@instagram</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-slate-500">@tiktok</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 overflow-hidden rounded-xl border border-slate-200">
                    ...
                    <div class="hidden h-44 items-center justify-center bg-slate-100 text-sm text-slate-500">
                        Map Preview
                    </div>
                </div>
                ...
                <div class="mt-4 flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500">Jalan Sukajadi, Pekanbaru, Riau</p>
                    </div>
                </div>
            </div>
        </div>
