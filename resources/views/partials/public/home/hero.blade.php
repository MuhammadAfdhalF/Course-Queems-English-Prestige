@php
$heroTitle = $heroSection?->title ?: 'Master English for Global Communication';

$heroSubtitle = $heroSection?->subtitle ?: 'Build real speaking, grammar, and test-ready skills with a clear learning path, practical exercises, and measurable progress so you can communicate confidently for study, work, and everyday global conversations.';
        ...
        <div class="max-w-2xl">
            ...
            <div class="reveal reveal-delay-3 mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <a href="{{ route('free-test') }}">
                    <x-ui.button variant="outline" class="w-full px-6 py-3 sm:w-auto">
                        Try Free Test
                    </x-ui.button>
                </a>
            </div>
