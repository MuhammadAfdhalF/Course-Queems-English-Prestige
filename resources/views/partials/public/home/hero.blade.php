<section class="relative overflow-hidden bg-white">
    <div class="mx-auto grid max-w-7xl items-center gap-12 px-4 py-14 lg:grid-cols-2 lg:px-8 lg:py-16">
        <div class="max-w-2xl">
            <div class="inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-amber-700">
                <span class="inline-block h-2 w-2 rounded-full bg-amber-500"></span>
                Premium Learning Program
            </div>

            <h1 class="mt-6 text-4xl font-extrabold leading-[1.05] text-slate-900 md:text-5xl lg:text-[72px]"> Master <br>English for
                <span class="block text-[var(--color-brand-gold)]">Global Communication</span>
            </h1>

            <p class="mt-6 max-w-xl text-base leading-8 text-slate-600"> Build real speaking, grammar, and test-ready skills with a clear learning path,
        ...
        <div class="relative">
            <div class="relative mx-auto max-w-xl">
                ...
                <div class="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-slate-50 to-blue-50 p-6 rounded-2xl border border-slate-200 bg-white p-6 ring-1 ring-slate-200">
                    <img
                ...
                <div class="absolute bottom-8 left-0 hidden w-56 rounded-2xl border border-slate-200 bg-white p-4 shadow-lg lg:block">
