        ...
        <div class="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            <div class="reveal">
                <a href="#" class="group motion-card block rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm transition duration-300 hover:shadow-md">
                    ...
                    <h3 class="mt-5 text-xl font-bold text-slate-900">Listening Test</h3>
                    <p class="mt-3 text-sm leading-7 text-slate-600">
                        15 minutes assessment of auditory comprehension and focus.
                    </p>
            ...
            <div class="reveal reveal-delay-1">
                <a href="#" class="group motion-card block rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm transition duration-300 hover:shadow-md">
                    ...
                    <h3 class="mt-5 text-xl font-bold text-slate-900">Reading Test</h3>
                    <p class="mt-3 text-sm leading-7 text-slate-600">
                        20 minutes deep-dive into complex text analysis and speed reading.
                    </p>
            ...
            <div class="reveal reveal-delay-2">
                <a href="{{ route('free-test.show') }}" class="group motion-card block rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm transition duration-300 hover:shadow-md">
                    ...
                    <p class="mt-3 text-sm leading-7 text-slate-600">
                        10 minutes evaluation of structural accuracy and formal writing style.
                    </p>
            ...
            <div class="reveal reveal-delay-3">
                <a href="#" class="group motion-card block rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm transition duration-300 hover:shadow-md">
                    ...
                    <p class="mt-3 text-sm leading-7 text-slate-600">
                        10 minutes evaluation word knowledge, collocation, and academic terms.
                    </p>
