...
<section class="mx-auto max-w-7xl space-y-6">
    <x-admin.page-toolbar
        ...
        <x-slot:actions>
            ...
            <form
                ...
                <input type="hidden" name="cancel_note" value="Cancelled from course access detail.">
    ...
    <x-admin.table-card class="border-rose-200 bg-rose-50 p-6">
        <h2 class="text-xl font-black text-rose-700">
            Cancel Course Access
        </h2>

        <p class="mt-2 max-w-3xl text-sm leading-6 text-rose-600">
        ...
        <form
            ...
            <div class="flex justify-end">
                <button
                    type="submit"
                    class="inline-flex h-12 items-center justify-center rounded-xl bg-rose-600 px-6 text-sm font-bold text-white shadow-sm transition hover:bg-rose-700">
                    Cancel Access
                </button>
            </div>
        </form>
