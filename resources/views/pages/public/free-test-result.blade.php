    ...
    <div class="mx-auto max-w-7xl px-4 py-14 lg:px-8 lg:py-16">
        <div class="mx-auto max-w-[760px]">
            ...
            <div class="mt-10 space-y-8">
                <div class="rounded-[20px] border border-slate-200 bg-white px-6 py-10 lg:px-10 lg:py-12">
                ...
                <div class="rounded-[20px] border border-[#efe4a7] bg-[#f7efb8] p-6 lg:p-8">
                ...
                <div class="rounded-[20px] border border-[#dbe4f1] bg-[#eaf1fb] p-6 lg:p-8">
                    <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                        <div class="max-w-sm">
                        ...
                        <div class="flex flex-col gap-3 sm:flex-row">
                            ...
                            <a
                                href="#"
                                class="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-900 transition hover:bg-slate-50 sm:w-auto">
