...
<div {{ $attributes->merge(['class' => 'overflow-hidden rounded-[18px] border border-slate-200 bg-white shadow-sm transition duration-200 hover:-translate-y-1 hover:shadow-md']) }}>
    ...
    <div class="p-5">
        ...
        <div class="mt-5">
            <a
                href="{{ $href }}"
                class="inline-flex items-center gap-2 text-sm font-bold text-[#2457E6] transition hover:gap-3">
                <span>Read More</span>
