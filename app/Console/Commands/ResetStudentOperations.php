...
class ResetStudentOperations extends Command
{
    protected $signature = 'app:reset-student-operations {--dry-run : Run simulation without deleting data} {--execute : Execute student and operational data reset}';

    protected $description = 'Student & Operational Data Reset (Purges student accounts and operational activity while preserving all courses, free test questions, certificate templates, and CMS)';
    ...
    public function handle(DataResetService $service): int
    {
        ...
        $this->info("==================================================");
        $this->info(" STUDENT & OPERATIONAL DATA RESET ");
        $this->info("==================================================");
        ...
        if ($execute) {
            ...
            $answer = $this->ask("WARNING: This will purge all student accounts and operational activity while keeping courses intact!\nTo proceed, type exact phrase: [{$phrase}]");
        ...
        try {
            ...
            $this->info("--------------------------------------------------");
            $this->info("STUDENT & OPERATIONAL DATA RESET COMPLETED SUCCESSFULLY.");
